...
export function processPasteBIZ() {
  ...
  state.pastedDataCache['input_stok_biz'] = null;
  ...
  state.pastedDataCache['input_stok_biz'] = data;
...
export function submitDataBIZ() {
  const button = document.querySelector('#input-stok-biz-submit-container button');
  submitPastedData({
    rpcName: 'savePastedDataBIZ',
    cacheKey: 'input_stok_biz',
    idPrefix: 'input-stok-biz',
    button: button,
    offerReload: false,
  });
}

export function clearBizForm() {
